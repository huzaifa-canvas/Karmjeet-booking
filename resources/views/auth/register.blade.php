            ...
            <div class="content-body">
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo-->
                       <a class="brand-logo col-md-auto mt-2" href="{{ route('home')}}">
                            <x-application-logo />
                                ...
                                <form class="auth-register-form mt-2" action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            ...
                                            <input class="form-control form-control-merge" id="register-password" type="password" name="password" placeholder="Password" aria-describedby="register-password" tabindex="3" />
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <span class="input-group-text" id="basic-addon5"> <i data-feather='lock' ></i></span>
                                            <input class="form-control form-control-merge" id="password_confirmation" type="password" name="password_confirmation" placeholder="Confirm Password" aria-describedby="register-password" tabindex="3" />
                                            <span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                        </div>
                                    ...
                                    <button class="btn btn-primary w-100 mt-3 p-2" tabindex="5">Sign up</button>
                                </form>
                                <p class="text-center mt-3"><span>Already have an account?</span>
